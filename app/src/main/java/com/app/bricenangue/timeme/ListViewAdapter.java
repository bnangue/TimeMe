...
//    Unterschrift [] unterschriftenArray;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.itemcategory = (TextView) convertView.findViewById(R.id.TextView_list_item_category);
            viewHolder.itemMarket = (TextView) convertView.findViewById(R.id.TextView_list_item_market);
        ...
        String itemCategory="("+shoppingItemsDBList.get(position).getItemcategory()+")";
        viewHolder.itemcategory.setText(itemCategory);
        viewHolder.itemMarket.setText(shoppingItemsDBList.get(position).getItemmarket());
